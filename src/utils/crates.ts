...
const MYTHIC_ITEMS: LootItem[] = [
  ...
  { id: 'mb-5', name: '★ The Golden FreebiesOnly Trophy ★', description: '100% Solid 24K Gold. Ultimate high-roller glory.', rarity: 'exotic', value: 35000, icon: '🏆', color: '#eab308', bgGradient: 'from-yellow-950 via-amber-950 to-purple-950', dropWeight: 0.05, lore: 'You won the casino. Now keep gambling.' },
];
...
const OVERLORD_ITEMS: LootItem[] = [
  ...
  { id: 'ov-4', name: '1% Ownership Stake in FreebiesOnly', description: 'Certified registered share certificate signed in gold ink.', rarity: 'exotic', value: 85000, icon: '📜', color: '#eab308', bgGradient: 'from-amber-950 via-yellow-950 to-emerald-950', dropWeight: 0.2, lore: 'The house always wins, and now you are the house.' },
